...
const ListCart = () => {
  ...
  const removeProductFromCart = useEcomStore(
        ...
        <>
          ...
          <div className="flex">
            ...
            <p className="text-2xl font-bold">
              Product In Cart: {carts?.length} product
            </p>
          </div>
          {/* List */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {carts.map((item, index) => {
              return (
                <div
                  key={index}
                  className="bg-white p-2 rounded-md shadow-md border-b mb-2 col-span-2 row-span-1"
                >
                  {/* Row 1 */}
            ...
            <div className="bg-white p-2 rounded-md shadow-md space-y-4">
              ...
              <button
                ...
                className="bg-red-500 hover:bg-red-700 w-full rounded-md text-white font-bold py-2 shadow-md"
              >
                Checkout
              </button>
              <Link
                to={"/shop"}
                className="inline-block text-center bg-gray-500 hover:bg-gray-700 w-full rounded-md text-white font-bold py-2 shadow-md"
              >
                Go Back To Shop
              </Link>
            </div>
